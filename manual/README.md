...
![](../complete_flowchart.png) Each box represents a Snakemake rule and
...
point. Please see the section below for detailed descriptions of each
Snakemake rule.
...
- [An lcWGS tutorial made for the physalia
  workshop](https://github.com/nt246/physalia-lcwgs)
- [An ANGSD pipeline built by Claire Mérot and Eric
  Normandeau](https://github.com/clairemerot/angsd_pipeline)
